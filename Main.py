...
def leer_palabras():
    ...
    name, seq = leer_archivo_fasta("APP.FASTA")
    palabras.append(seq)
    names.append(name)
    name, seq = leer_archivo_fasta("MAPK3.FASTA")
    palabras.append(seq)
    names.append(name)
    name, seq = leer_archivo_fasta("PRKACA.FASTA")
    palabras.append(seq)
    names.append(name)
    name, seq = leer_archivo_fasta("PSEN2.FASTA")
    palabras.append(seq)
    names.append(name)
